<%-- 
    ...
    Created on : Nov 20, 2017, 4:47:07 PM
    Author     : Sanjeev
--%>
			...
			<!-- Main -->
				<article id="main">
					...
					<header class="special container">
						...
						<h2>User <strong>History</strong></h2>
						<p>Where can view the polling history</p>
					</header>
...
%><tr>
    <td>
[<%= rs.getInt("poll_id") %>]
[<a href="view-polles.jsp?poll_id=<%= rs.getInt("poll_id") %>" target="_blank"><%= trans.s("common.view","View") %></a>]
<% if(rs.getString("expired").compareToIgnoreCase("N")==0) { %>
[<a href="vote-polles.jsp?poll_id=<%= rs.getInt("poll_id") %>" target="_blank"><%= trans.s("common.vote","Vote") %></a>]
<% } else { %>
...
<tr>
    <td>&nbsp;</td><td><b><%= trans.s("common.description","Description") %>:</b> </td>
