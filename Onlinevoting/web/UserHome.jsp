					...
					<nav id="nav">
						<ul>
							<li class="current"><a href="#">Home</a></li>
                                                        <li class=""><a href="viewhistory.jsp">View History</a></li>
			...
			<!-- Main -->
				<article id="main">
					...
					<header class="special container">
						...
						<h2>User <strong>Home</strong></h2>
						<p>Where user can vote</p>
					</header>
					...
					<!-- One -->
						<section class="wrapper style4 container">
							...
							<!-- Content -->
								<div class="content">
									<section>
                                                                            <a href="#" class="image featured"><img src="images/vote1.jpg" alt="" /></a>
									</section>
								</div>
